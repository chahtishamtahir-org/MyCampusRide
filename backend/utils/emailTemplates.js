...
const getDriverApprovalEmailHtml = (name = '') => {
...
<head>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Driver Account Approved</title>
  <style>
    body {
      font-family: 'Inter', -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, sans-serif;
      background-color: #F8FAFC;
...
<body>
  <div class="wrapper">
    <div class="container">
      ...
      <div class="content">
        <h1>${greeting}</h1>
        <p>Great news! Your driver account application has been approved by the administrative team.</p>
        <p>You can now log in to the driver portal, start scheduled trips, view passengers, and manage your tracking details.</p>
        <div class="btn-container">
          <a href="${process.env.FRONTEND_URL || 'http://localhost:5173'}/login" class="btn" style="color: #ffffff;">Log In to Driver Portal</a>
        </div>
      </div>
      <div class="footer">
        &copy; 2026 MyCampusRide. All rights reserved.
